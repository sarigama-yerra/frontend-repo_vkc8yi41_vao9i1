...
export default function CTA() {
  return (
    <section className="mx-auto max-w-6xl px-6 pb-28">
      <motion.div
        className="overflow-hidden rounded-3xl border bg-gradient-to-br from-rose-50 via-white to-fuchsia-50 p-8 md:p-12"
      ...
      >
        <div className="grid items-center gap-6 md:grid-cols-2" dir="rtl">
          <div>
            <h3 className="text-2xl font-bold text-gray-900">با «بـرهـه» شروع تازه‌ای بساز</h3>
